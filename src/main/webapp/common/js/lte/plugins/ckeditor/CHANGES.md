...
* [#13859](http://dev.ckeditor.com/ticket/13859): TestMain cases created with `bender.tools.createTestsForEditors` will also receive editor bot as a second parameter.
